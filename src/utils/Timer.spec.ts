...
describe("Timer", () => {
  it("should reset timestamp and timerId to null on reset", () => {
  ...
  it("should return -1 when comparing with another timestamp, if its own is null", () => {
  ...
  it("should return the difference between given timestamps and own timestamps when comparing", () => {
  ...
  it("should set clear its interval, set its own values correctly, then calls setTimeout", () => {
